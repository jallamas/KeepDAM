...
class InitDataComponent(
    ...
    fun initData()  {
        ...
        val user1notas = listOf(
                ...
                Nota("Tareas pendientes", "Hacer la compra. Peluquería, Limpieza",
                LocalDate.of(2020, 3, 14), LocalDate.of(2020, 3, 14),user1)
        )
        notaRepository.saveAll(user1notas)

        val user2 = User("jallamas1", encoder.encode("12345678"),"José Antonio Llamas")
        userRepository.save(user2)

        val user2notas = listOf(
                Nota("AAAA", "Harina, levadura, chocolate, huevos.",
                        LocalDate.of(2020, 3, 12), LocalDate.of(2020, 3, 13),user2),
                Nota("TBBBB", "Hacer la compra. Peluquería, Limpieza",
